...
EXPERIMENT_SUITES: dict[str, dict[str, Any]] = {
    ...
    "activsg2000-gpu-gap-sensitivity-v6": {
        "case_name": "ACTIVSg2000",
        "benchmark_prefix": "activsg2000-gpu-gap-v6",
        "required_git_tag": "experiment-2000-gpu-gap-v6",
        "allowed_gap_labels": ("1e-3",),
        "platform": "dgx_spark",
        "required_profile": {
            "solver": "cuopt",
        ...
        # Keep the same cumulative solve allowance as v5. Only the registered
        # cuOpt PDLP policy and the frozen identity change in v6.
        "deadline_seconds": 1035.0,
        "verification_reserve_seconds": 120.0,
        "serialization_reserve_seconds": 15.0,
    },
    ...
    "activsg2000-gpu-gap-sensitivity-v8": {
        "case_name": "ACTIVSg2000",
        "benchmark_prefix": "activsg2000-gpu-gap-v8",
        "required_git_tag": "experiment-2000-gpu-gap-v8",
        "allowed_gap_labels": ("1e-3",),
        "platform": "dgx_spark",
        "required_profile": {
            "solver": "cuopt",
        ...
        # Preserve v7's 1,800-second solver allowance. V8 changes only the
        # MIP-start/native-log contract and constraint-generation controller.
        "deadline_seconds": 1935.0,
        "verification_reserve_seconds": 120.0,
        "serialization_reserve_seconds": 15.0,
    },
    "activsg2000-gpu-gap-sensitivity-v9": {
        "case_name": "ACTIVSg2000",
        "benchmark_prefix": "activsg2000-gpu-gap-v9",
        "required_git_tag": "experiment-2000-gpu-gap-v9",
        "allowed_gap_labels": ("1e-3",),
        "platform": "dgx_spark",
        "required_profile": {
            "solver": "cuopt",
            ...
            "mip_start_precheck": "highs_fixed_commitment_lp_v1",
        ...
        # Preserve v8's 1,800-second solver allowance. V9 changes only the
        # MIP-start translation and feasibility-check policy.
        "deadline_seconds": 1935.0,
        "verification_reserve_seconds": 120.0,
        "serialization_reserve_seconds": 15.0,
    },
    "activsg2000-gpu-commitment-trace-v10": {
        "case_name": "ACTIVSg2000",
        "benchmark_prefix": "activsg2000-gpu-commitment-trace-v10",
        "required_git_tag": "experiment-2000-gpu-commitment-trace-v10",
        "allowed_gap_labels": ("1e-3",),
        "platform": "dgx_spark",
        "required_profile": {
            "solver": "cuopt",
    ...
    "activsg2000-gpu-commitment-trace-v11": {
        "case_name": "ACTIVSg2000",
        "benchmark_prefix": "activsg2000-gpu-commitment-trace-v11",
        "required_git_tag": "experiment-2000-gpu-commitment-trace-v11",
        "allowed_gap_labels": ("1e-3",),
        "platform": "dgx_spark",
        "required_profile": {
            "solver": "cuopt",
