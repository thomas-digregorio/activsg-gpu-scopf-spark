...
image=activsg-gpu-scopf-spark:experiment-2000-gpu-lagrangian-v15
suite=activsg2000-gpu-lagrangian-v15
...
docker run --rm --gpus all \
  ...
  --config /workspace/configs/activsg2000-gpu-lagrangian-v15.json \
