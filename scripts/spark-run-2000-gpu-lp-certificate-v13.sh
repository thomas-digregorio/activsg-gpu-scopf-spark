...
tag=experiment-2000-gpu-lp-certificate-v13
image=activsg-gpu-scopf-spark:experiment-2000-gpu-lp-certificate-v13
suite=activsg2000-gpu-lp-certificate-v13
...
docker run --rm --gpus all \
  ...
  "$image" \
  lp-certificate \
  --config /workspace/configs/activsg2000-gpu-lp-certificate-v13.json \
