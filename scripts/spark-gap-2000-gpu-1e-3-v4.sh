...
tag=experiment-2000-gpu-gap-v4
image=activsg-gpu-scopf-spark:experiment-2000-gpu-gap-v4
suite=activsg2000-gpu-gap-sensitivity-v4
output=activsg2000-gpu-gap-v4-1e-3-dgx-spark.json
console_log="$repo/results/experiments/activsg2000-gpu-gap-v4-1e-3-cuopt-console.log"
...
docker run --rm --gpus all \
  ...
  "$image" \
  gap-experiment \
  --config /workspace/configs/activsg2000-gpu-gap-1e-3-v4.json \
