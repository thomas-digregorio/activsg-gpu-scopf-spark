...
image=activsg-gpu-scopf-spark:diagnostic-2000-gpu-round2-cpu-seed-v2
diagnostic_id=activsg2000-gpu-round2-cpu-seed-diagnostic-v2
...
docker run --rm --gpus all \
  ...
  --config /workspace/configs/activsg2000-gpu-round2-cpu-seed-diagnostic-v2.json \
