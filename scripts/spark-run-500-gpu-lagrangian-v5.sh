...
image=activsg-gpu-scopf-spark:experiment-500-gpu-lagrangian-v5
suite=activsg500-gpu-lagrangian-v5
...
docker run --rm --gpus all \
  ...
  --config /workspace/configs/activsg500-gpu-lagrangian-v5.json \
