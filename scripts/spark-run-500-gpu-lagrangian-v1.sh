...
tag=experiment-500-gpu-lagrangian-v1
image=activsg-gpu-scopf-spark:experiment-500-gpu-lagrangian-v1
suite=activsg500-gpu-lagrangian-v1
...
docker run --rm --gpus all \
  ...
  --config /workspace/configs/activsg500-gpu-lagrangian-v1.json \
