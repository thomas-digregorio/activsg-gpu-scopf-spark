...
image=activsg-gpu-scopf-spark:experiment-2000-gpu-lagrangian-v11
suite=activsg2000-gpu-lagrangian-v11
...
docker run --rm --gpus all \
  ...
  --config /workspace/configs/activsg2000-gpu-lagrangian-v11.json \
