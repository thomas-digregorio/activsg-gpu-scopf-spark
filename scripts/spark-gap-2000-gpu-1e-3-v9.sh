...
tag=experiment-2000-gpu-gap-v9
image=activsg-gpu-scopf-spark:experiment-2000-gpu-gap-v9
suite=activsg2000-gpu-gap-sensitivity-v9
output=activsg2000-gpu-gap-v9-1e-3-dgx-spark.json
console_log="$repo/results/experiments/activsg2000-gpu-gap-v9-1e-3-cuopt-console.log"
...
docker run --rm --gpus all \
  ...
  "$image" \
  gap-experiment \
  --config /workspace/configs/activsg2000-gpu-gap-1e-3-v9.json \
