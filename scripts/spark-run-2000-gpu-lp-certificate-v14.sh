...
tag=experiment-2000-gpu-lp-certificate-v14
image=activsg-gpu-scopf-spark:experiment-2000-gpu-lp-certificate-v14
suite=activsg2000-gpu-lp-certificate-v14
...
docker run --rm --gpus all \
  ...
  "$image" \
  lp-certificate \
  --config /workspace/configs/activsg2000-gpu-lp-certificate-v14.json \
