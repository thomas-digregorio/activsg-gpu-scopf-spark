...
image=activsg-gpu-scopf-spark:experiment-2000-gpu-lagrangian-v20
suite=activsg2000-gpu-lagrangian-v20
...
docker run --rm --gpus all \
  ...
  --config /workspace/configs/activsg2000-gpu-lagrangian-v20.json \
