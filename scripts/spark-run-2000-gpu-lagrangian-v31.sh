...
image=activsg-gpu-scopf-spark:experiment-2000-gpu-lagrangian-v31
suite=activsg2000-gpu-lagrangian-v31
...
docker run --rm --gpus all \
  ...
  --config /workspace/configs/activsg2000-gpu-lagrangian-v31.json \
