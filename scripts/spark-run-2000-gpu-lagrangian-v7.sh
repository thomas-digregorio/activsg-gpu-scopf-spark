...
image=activsg-gpu-scopf-spark:experiment-2000-gpu-lagrangian-v7
suite=activsg2000-gpu-lagrangian-v7
...
docker run --rm --gpus all \
  ...
  --config /workspace/configs/activsg2000-gpu-lagrangian-v7.json \
