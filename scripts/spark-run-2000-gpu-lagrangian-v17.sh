...
image=activsg-gpu-scopf-spark:experiment-2000-gpu-lagrangian-v17
suite=activsg2000-gpu-lagrangian-v17
...
docker run --rm --gpus all \
  ...
  --config /workspace/configs/activsg2000-gpu-lagrangian-v17.json \
