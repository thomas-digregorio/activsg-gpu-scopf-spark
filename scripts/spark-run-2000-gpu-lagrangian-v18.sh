...
image=activsg-gpu-scopf-spark:experiment-2000-gpu-lagrangian-v18
suite=activsg2000-gpu-lagrangian-v18
...
docker run --rm --gpus all \
  ...
  --config /workspace/configs/activsg2000-gpu-lagrangian-v18.json \
