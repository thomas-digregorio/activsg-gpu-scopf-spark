...
tag=experiment-2000-gpu-lp-certificate-v15
image=activsg-gpu-scopf-spark:experiment-2000-gpu-lp-certificate-v15
suite=activsg2000-gpu-lp-certificate-v15
...
docker run --rm --gpus all \
  ...
  "$image" \
  lp-certificate \
  --config /workspace/configs/activsg2000-gpu-lp-certificate-v15.json \
